    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arrangement', models.CharField(blank=True, max_length=255, verbose_name='arrangement')),
                ('originally_from', models.CharField(blank=True, max_length=255, verbose_name='opphaveleg ifrå')),
                ('sound_file', models.FileField(blank=True, default='', upload_to='sheetmusic/sound_files/', validators=[common.forms.validators.FileTypeValidator({'audio/flac': ['.flac'], 'audio/midi': ['.midi', '.mid'], 'audio/mp4': ['.mp4', '.m4a'], 'audio/mpeg': ['.mp3'], 'audio/ogg': ['.ogg']})], verbose_name='lydfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(default=None, max_length=255, upload_to='sheetmusic/original_pdfs/', validators=[common.forms.validators.FileTypeValidator({'application/pdf': ['.pdf'], 'application/x-bzpdf': ['.pdf'], 'application/x-gzpdf': ['.pdf'], 'application/x-pdf': ['.pdf']})], verbose_name='fil')),
                ('filename_original', models.CharField(max_length=255, verbose_name='opphaveleg filnamn')),
                ('slug', autoslug.fields.AutoSlugField(editable=True, populate_from=sheetmusic.models.pdf_filename_no_extension, unique_with=('score__slug',), verbose_name='lenkjenamn')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('part_number', models.IntegerField(blank=True, null=True, verbose_name='stemmenummer')),
                ('note', models.CharField(blank=True, max_length=255, verbose_name='merknad')),
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='tidsmerke')),
                ('slug', autoslug.fields.AutoSlugField(editable=True, populate_from=sheetmusic.models.Part.__str__, unique_with=('pdf__score__slug',), verbose_name='lenkjenamn')),
                ('instrument_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parts', to='instruments.instrumenttype', verbose_name='instrumenttype')),
            ...
            options={
                ...
                'ordering': ['instrument_type', django.db.models.expressions.OrderBy(django.db.models.expressions.F('part_number'), nulls_first=True), 'note'],
            },
        ),
        migrations.CreateModel(
            name='FavoritePart',
