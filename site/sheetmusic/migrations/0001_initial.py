    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sound_file', models.FileField(blank=True, default='', upload_to='sheetmusic/sound_files/', validators=[common.validators.FileTypeValidator({'audio/flac': ['.flac'], 'audio/midi': ['.midi', '.mid'], 'audio/mp4': ['.mp4', '.m4a'], 'audio/mpeg': ['.mp3'], 'audio/ogg': ['.ogg']})], verbose_name='lydfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(default=None, max_length=255, upload_to='sheetmusic/original_pdfs/', validators=[common.validators.FileTypeValidator({'application/pdf': ['.pdf'], 'application/x-bzpdf': ['.pdf'], 'application/x-gzpdf': ['.pdf'], 'application/x-pdf': ['.pdf']})], verbose_name='fil')),
