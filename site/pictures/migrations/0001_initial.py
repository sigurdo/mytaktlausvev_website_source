    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_to",
                    models.DateField(blank=True, null=True, verbose_name="til dato"),
                ),
                (
                    "slug",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=1024, verbose_name="beskrivelse"
                    ),
                ),
                (
                    "uploaded",
                    models.DateTimeField(auto_now_add=True, verbose_name="lasta opp"),
                ),
                (
                    "order",
                    models.FloatField(
                        default=0,
                        help_text="Definerer rekkjefølgja til biletet. Bilete med lik rekkjefølgje vert sortert etter tidspunkt for opplasting.",
